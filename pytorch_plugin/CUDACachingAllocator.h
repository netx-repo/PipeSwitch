...
C10_CUDA_API void allocateSharedCache();
C10_CUDA_API void sendSharedCache();
C10_CUDA_API void recvSharedCache();
C10_CUDA_API void insertSharedCache(size_t size, size_t offset);
C10_CUDA_API void clearSharedCache();
